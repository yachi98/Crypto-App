...
const Home = () => {
  ...
  return (
    <main>
      ...
      <div className="dark:bg-[#050507] bg-white dark:text-white text-black p-1 rounded-xl w-[180px] flex items-center mt-5 text-xs">
        <button
          onClick={() => setShowConverter(!showConverter)}
          className={`${
            !showConverter && "dark:bg-[#0f0f14] bg-gray-300 rounded-xl"
