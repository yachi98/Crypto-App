    ...
    <div className="relative" ref={containerRef}>
      ...
      {showDropdown && (
        <motion.div
          ...
          className="absolute left-0 backdrop-filter dark:bg-gray-900 bg-white backdrop-blur overflow-hidden z-30 gap-3 w-full flex flex-col justify-left rounded-b-xl p-3 dark:text-white text-black text-xs font-light"
        >
