  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className={`w-[90px] dark:bg-[#101010] bg-white p-2 rounded-xl text-xs dark:text-white text-black font-light flex gap-2 items-center justify-center ${
      ...
      {showDropdown && (
        <motion.div
          ...
          className="absolute left-0 dark:bg-[#101010] bg-white z-30 gap-3 w-full flex flex-col justify-left rounded-b-xl p-3 dark:text-white text-black text-xs font-light"
        >
