...
const RowCoinItem = ({ coin }: { coin: Coin }) => {
  ...
  return (
    <Link href={`/coin/${coin.id}`}>
      <div className="dark:bg-[#050507] bg-white dark:hover:bg-[#0d0d13] w-full dark:text-[#DEDEDE] text-black text-sm font-light rounded-3xl p-5 mb-2 flex gap-3 items-center">
