...
const RowCoinItem = ({ coin }: { coin: Coin }) => {
  ...
  return (
    <Link href={`/coin/${coin.id}`}>
      <div className="dark:bg-[#0d121d] bg-white dark:hover:bg-[#121929] hover:bg-[#efefef] w-full dark:text-[#DEDEDE] text-black text-sm font-light rounded-3xl p-4 mb-2 flex gap-3 items-center">
