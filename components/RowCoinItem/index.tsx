...
const RowCoinItem = ({ coin }: { coin: Coin }) => {
  ...
  return (
    <div className="dark:bg-gradient-to-r from-black to-gray-900 bg-white w-full text-[#DEDEDE] text-sm font-light rounded-3xl p-5 mb-2 flex gap-3 items-center">
